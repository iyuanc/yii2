...
class BaseIpHelper
{
    ...
    /**
     * 检测 IP 地址是否正确 或者 子网 $subnet 包含了 $subnet。
     *
     ...
     * ```
     *
     * @param string $subnet 有效地 IPv4 或者 IPv6 地址或者 CIDR 范围，e.g.: `10.0.0.0/8` 或者 `2001:af::/64`
     * @param string $range 有效地 IPv4 或者 IPv6 CIDR 范围，e.g. `10.0.0.0/8` 或者 `2001:af::/64`
